    ...
    : playHead(_playHead)
{
    ...
    timeLabel->setFont (Font (Font::getDefaultMonospacedFontName(), 14.00f, Font::plain).withTypefaceStyle ("Regular").withExtraKerningFactor (-0.074f));
    ...
    positionLabel->setFont (Font (Font::getDefaultMonospacedFontName(), 14.00f, Font::plain).withTypefaceStyle ("Regular").withExtraKerningFactor (-0.065f));
