    ...
    : AudioProcessorEditor (ownerFilter)
{
    ...
    textButton1.reset (new TextButton ("new button"));
    ...
    b_Play.reset (new TextButton ("Play"));
    ...
    b_Play->setColour (TextButton::textColourOffId, Colours::black);
    b_Play->setColour (TextButton::textColourOnId, Colours::white);

    b_Play->setBounds (78, 117, 72, 50);

    b_Record.reset (new TextButton ("Record"));
    ...
    b_Overdub.reset (new TextButton ("Overdub"));
    ...
    b_Thru.reset (new TextButton ("MIDI Thru"));
    ...
    b_Clear.reset (new TextButton ("Clear"));
    ...
    b_Clear->setColour (TextButton::textColourOffId, Colours::white);
    b_Clear->setColour (TextButton::textColourOnId, Colours::azure);

    b_Clear->setBounds (264, 90, 39, 22);

    stepsizeBox.reset (new ComboBox ("Loop Step Size"));
    ...
    label3->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label4->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label5->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label6->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label7->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label8->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    loopmodeBox.reset (new ComboBox ("Loop Mode"));
    ...
    notetriggerBox.reset (new ComboBox ("Note Trigger"));
    ...
    syncmodeBox.reset (new ComboBox ("Sync"));
    ...
    label9->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label10->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label11->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label12.reset (new Label ("Trigger Channel",
                              TRANS("Channel")));
    addAndMakeVisible (label12.get());
    label12->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    b_Reload.reset (new TextButton ("Load"));
    ...
    quantizeBox.reset (new ComboBox ("Input Quantize Step"));
    ...
    label21.reset (new Label ("LoopStepSize",
                              TRANS("Loop Step Size")));
    addAndMakeVisible (label21.get());
    label21->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label2.reset (new Label ("Shift",
                             TRANS("Beat Shift")));
    addAndMakeVisible (label2.get());
    label2->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label23.reset (new Label ("QuantizeLabel",
                              TRANS("Quantize Input")));
    addAndMakeVisible (label23.get());
    label23->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    nameLabel->setFont (Font (26.3f, Font::plain).withTypefaceStyle ("Bold"));
    ...
    b_Save.reset (new TextButton ("Save"));
    ...
    label22.reset (new Label ("Sync",
                              TRANS("Host Sync Mode")));
    addAndMakeVisible (label22.get());
    label22->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label18.reset (new Label ("Sync:",
                              TRANS("Note Triggering")));
    addAndMakeVisible (label18.get());
    label18->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Bold"));
    ...
    loopinfoLabel.reset (new Label ("Loop Info",
                                    TRANS("label text")));
    addAndMakeVisible (loopinfoLabel.get());
    loopinfoLabel->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    loopinfoLabel->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    loopinfoLabel->setBounds (14, 205, 272, 16);

    loopinfoLabel2.reset (new Label ("Loop Info 2",
                                     TRANS("label text")));
    addAndMakeVisible (loopinfoLabel2.get());
    loopinfoLabel2->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    loopinfoLabel2->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    loopinfoLabel2->setBounds (14, 225, 272, 16);

    label17.reset (new Label ("Sync:",
                              TRANS("Loop Manipulation")));
    addAndMakeVisible (label17.get());
    label17->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Bold"));
    ...
    label19.reset (new Label ("I/O Channel",
                              TRANS("I/O Channel")));
    addAndMakeVisible (label19.get());
    label19->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label20.reset (new Label ("RecordLengthLabel",
                              TRANS("Record Length")));
    addAndMakeVisible (label20.get());
    label20->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    b_Filt.reset (new TextButton ("Transform/Filter"));
    ...
    b_Filt->setColour (TextButton::textColourOffId, Colours::black);
    ...
    b_NoteToggle.reset (new TextButton ("new button"));
    ...
    label13.reset (new Label ("Trigger Channel",
                              TRANS("Play Group")));
    addAndMakeVisible (label13.get());
    label13->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label14.reset (new Label ("Trigger Channel",
                              TRANS("Mute Group")));
    addAndMakeVisible (label14.get());
    label14->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    b_Snap.reset (new ToggleButton ("new toggle button"));
    ...
    quantizeBox2.reset (new ComboBox ("PR Quantize Step"));
    ...
    b_ForceToKey.reset (new ToggleButton ("new toggle button"));
    ...
    b_ShiftUp.reset (new TextButton ("new button"));
    ...
    b_ShiftDown.reset (new TextButton ("new button"));
    ...
    b_SingleLoop.reset (new ToggleButton ("Single Loop"));
    ...
    label15->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    aboutButton.reset (new ImageButton ("new button"));
    ...
    b_Triplet.reset (new TextButton ("Triplet"));
    ...
    b_Dotted.reset (new TextButton ("Dotted"));
    ...
    b_ZoomOut.reset (new TextButton ("ZoomOut"));
    ...
    b_ZoomIn.reset (new TextButton ("ZoomIn"));
    ...
    numerator.reset (new Label ("new label",
                                TRANS("4")));
    addAndMakeVisible (numerator.get());
    numerator->setTooltip (TRANS("Time Sig Numerator"));
    numerator->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    numerator->setColour (TextEditor::backgroundColourId, Colour (0x00000000));
    numerator->addListener (this);

    numerator->setBounds (555, 64, 27, 18);

    denominator.reset (new Label ("new label",
                                  TRANS("4")));
    addAndMakeVisible (denominator.get());
    denominator->setTooltip (TRANS("Time Sig Denominator"));
    denominator->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    denominator->setColour (TextEditor::backgroundColourId, Colour (0x00000000));
    denominator->addListener (this);

    denominator->setBounds (584, 64, 29, 18);

    loopinfoLabel3.reset (new Label ("Loop Info 2",
                                     TRANS("DEMO VERSION")));
    addAndMakeVisible (loopinfoLabel3.get());
    loopinfoLabel3->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Bold"));
    ...
    loopinfoLabel3->setColour (TextEditor::backgroundColourId, Colour (0x00000000));

    loopinfoLabel3->setBounds (5, 47, 141, 16);

    b_UseScaleChannel.reset (new ToggleButton ("new toggle button"));
    ...
    label25.reset (new Label ("scale ch",
                              TRANS("Scale Ch")));
    addAndMakeVisible (label25.get());
    label25->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    label26->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    b_WaitForBar.reset (new ToggleButton ("WaitForBar"));
    ...
    midiOutDeviceBox.reset (new ComboBox ("midiOutDevice"));
    ...
    label27.reset (new Label ("QuantizeLabel",
                              TRANS("MIDI Output Device")));
    addAndMakeVisible (label27.get());
    label27->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    b_UseTrChannel.reset (new ToggleButton ("new toggle button"));
    ...
    b_ImmediateTranspose.reset (new ToggleButton ("new toggle button"));
    ...
    label16.reset (new Label ("Sync:",
                              TRANS("Loop Settings")));
    addAndMakeVisible (label16.get());
    label16->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Bold"));
    ...
    forceModeBox.reset (new ComboBox ("Force To Scale Mode"));
    ...
    kbport.reset (new Viewport ("Keyboard View"));
    ...
    b_RemoveBar.reset (new TextButton ("RemoveBar"));
    ...
    b_AddBar.reset (new TextButton ("AddBar"));
    ...
    LengthLabel.reset (new Label ("Length",
                                  TRANS("4")));
    addAndMakeVisible (LengthLabel.get());
    LengthLabel->setTooltip (TRANS("Pattern length in bars"));
    LengthLabel->setFont (Font (15.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    textButton18.reset (new TextButton ("new button"));
    ...
    textButton19.reset (new TextButton ("new button"));
    ...
    textButton20.reset (new TextButton ("new button"));
    ...
    textButton21.reset (new TextButton ("new button"));
    ...
    textButton22.reset (new TextButton ("new button"));
    ...
    textButton23.reset (new TextButton ("new button"));
    ...
    textButton24.reset (new TextButton ("new button"));
    ...
    textButton25.reset (new TextButton ("new button"));
    ...
    textButton26.reset (new TextButton ("new button"));
    ...
    textButton27.reset (new TextButton ("new button"));
    ...
    textButton28.reset (new TextButton ("new button"));
    ...
    textButton29.reset (new TextButton ("new button"));
    ...
    textButton30.reset (new TextButton ("new button"));
    ...
    textButton31.reset (new TextButton ("new button"));
    ...
    textButton32.reset (new TextButton ("new button"));
    ...
    textButton33.reset (new TextButton ("new button"));
    ...
    textButton34.reset (new TextButton ("new button"));
    ...
    textButton35.reset (new TextButton ("new button"));
    ...
    textButton36.reset (new TextButton ("new button"));
    ...
    textButton37.reset (new TextButton ("new button"));
    ...
    textButton38.reset (new TextButton ("new button"));
    ...
    textButton39.reset (new TextButton ("new button"));
    ...
    textButton40.reset (new TextButton ("new button"));
    ...
    textButton41.reset (new TextButton ("new button"));
    ...
    textButton42.reset (new TextButton ("new button"));
    ...
    textButton43.reset (new TextButton ("new button"));
    ...
    textButton44.reset (new TextButton ("new button"));
    ...
    textButton45.reset (new TextButton ("new button"));
    ...
    textButton46.reset (new TextButton ("new button"));
    ...
    textButton47.reset (new TextButton ("new button"));
    ...
    textButton48.reset (new TextButton ("new button"));
    ...
    textButton49.reset (new TextButton ("new button"));
    ...
    textButton50.reset (new TextButton ("new button"));
    ...
    textButton51.reset (new TextButton ("new button"));
    ...
    textButton52.reset (new TextButton ("new button"));
    ...
    textButton53.reset (new TextButton ("new button"));
    ...
    textButton54.reset (new TextButton ("new button"));
    ...
    textButton55.reset (new TextButton ("new button"));
    ...
    textButton56.reset (new TextButton ("new button"));
    ...
    textButton57.reset (new TextButton ("new button"));
    ...
    textButton58.reset (new TextButton ("new button"));
    ...
    textButton59.reset (new TextButton ("new button"));
    ...
    textButton60.reset (new TextButton ("new button"));
    ...
    textButton61.reset (new TextButton ("new button"));
    ...
    textButton62.reset (new TextButton ("new button"));
    ...
    textButton63.reset (new TextButton ("new button"));
    ...
    textButton64.reset (new TextButton ("new button"));
    ...
    textButton65.reset (new TextButton ("new button"));
    ...
    textButton66.reset (new TextButton ("new button"));
    ...
    textButton67.reset (new TextButton ("new button"));
    ...
    textButton68.reset (new TextButton ("new button"));
    ...
    textButton69.reset (new TextButton ("new button"));
    ...
    textButton70.reset (new TextButton ("new button"));
    ...
    textButton71.reset (new TextButton ("new button"));
    ...
    textButton72.reset (new TextButton ("new button"));
    ...
    textButton73.reset (new TextButton ("new button"));
    ...
    textButton74.reset (new TextButton ("new button"));
    ...
    textButton75.reset (new TextButton ("new button"));
    ...
    textButton76.reset (new TextButton ("new button"));
    ...
    textButton77.reset (new TextButton ("new button"));
    ...
    textButton78.reset (new TextButton ("new button"));
    ...
    textButton79.reset (new TextButton ("new button"));
    ...
    textButton80.reset (new TextButton ("new button"));
    ...
    textButton81.reset (new TextButton ("new button"));
    ...
    textButton82.reset (new TextButton ("new button"));
    ...
    textButton83.reset (new TextButton ("new button"));
    ...
    textButton84.reset (new TextButton ("new button"));
    ...
    textButton85.reset (new TextButton ("new button"));
    ...
    textButton86.reset (new TextButton ("new button"));
    ...
    textButton87.reset (new TextButton ("new button"));
    ...
    textButton88.reset (new TextButton ("new button"));
    ...
    textButton89.reset (new TextButton ("new button"));
    ...
    textButton90.reset (new TextButton ("new button"));
    ...
    textButton91.reset (new TextButton ("new button"));
    ...
    textButton92.reset (new TextButton ("new button"));
    ...
    textButton93.reset (new TextButton ("new button"));
    ...
    textButton94.reset (new TextButton ("new button"));
    ...
    textButton95.reset (new TextButton ("new button"));
    ...
    textButton96.reset (new TextButton ("new button"));
    ...
    textButton97.reset (new TextButton ("new button"));
    ...
    textButton98.reset (new TextButton ("new button"));
    ...
    textButton99.reset (new TextButton ("new button"));
    ...
    textButton100.reset (new TextButton ("new button"));
    ...
    textButton101.reset (new TextButton ("new button"));
    ...
    textButton102.reset (new TextButton ("new button"));
    ...
    textButton103.reset (new TextButton ("new button"));
    ...
    textButton104.reset (new TextButton ("new button"));
    ...
    textButton105.reset (new TextButton ("new button"));
    ...
    textButton106.reset (new TextButton ("new button"));
    ...
    textButton107.reset (new TextButton ("new button"));
    ...
    textButton108.reset (new TextButton ("new button"));
    ...
    textButton109.reset (new TextButton ("new button"));
    ...
    textButton110.reset (new TextButton ("new button"));
    ...
    textButton111.reset (new TextButton ("new button"));
    ...
    textButton112.reset (new TextButton ("new button"));
    ...
    textButton113.reset (new TextButton ("new button"));
    ...
    textButton114.reset (new TextButton ("new button"));
    ...
    textButton115.reset (new TextButton ("new button"));
    ...
    textButton116.reset (new TextButton ("new button"));
    ...
    textButton117.reset (new TextButton ("new button"));
    ...
    textButton118.reset (new TextButton ("new button"));
    ...
    textButton119.reset (new TextButton ("new button"));
    ...
    textButton120.reset (new TextButton ("new button"));
    ...
    textButton121.reset (new TextButton ("new button"));
    ...
    textButton122.reset (new TextButton ("new button"));
    ...
    textButton123.reset (new TextButton ("new button"));
    ...
    textButton124.reset (new TextButton ("new button"));
    ...
    textButton125.reset (new TextButton ("new button"));
    ...
    textButton126.reset (new TextButton ("new button"));
    ...
    textButton127.reset (new TextButton ("new button"));
    ...
    textButton128.reset (new TextButton ("new button"));
    ...
    b_Transpose10.reset (new TextButton ("new button"));
    ...
    b_KeepLength.reset (new ToggleButton ("OverdubMode"));
    ...
    label24->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    b_Monitor.reset (new TextButton ("MIDI_Monitor"));
    ...
    label28.reset (new Label ("tr ch",
                              TRANS("Transpose Ch")));
    addAndMakeVisible (label28.get());
    label28->setFont (Font (12.0f, Font::plain).withTypefaceStyle ("Regular"));
    ...
    cachedImage_piznew40_png_1 = ImageCache::getFromMemory (piznew40_png, piznew40_pngSize);

    //[UserPreSize]
	DBG("PizLooperEditor()");
    aboutButton->setTooltip (L"Insert Piz Here-> midiLooper v" +String("1.0")+" http://thepiz.org/plugins/?p=midiLooper");
    ...
    loopinfoLabel2->setText("Stopped",NotificationType::dontSendNotification);
...
void PizLooperEditor::paint (Graphics& g)
{
...

    {
        ...
        Colour fillColour1 = Colours::black, fillColour2 = Colour (0xff404049);
...

    {
        ...
        Colour fillColour1 = Colours::black, fillColour2 = Colour (0xff162938);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setGradientFill (ColourGradient (fillColour1,
                                       190.0f - 305.0f + x,
...

    {
        ...
        Colour fillColour = Colour (0xffa0a0a0);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
...

    {
        ...
        Colour fillColour1 = Colours::black, fillColour2 = Colour (0xff404049);
        Colour strokeColour = Colour (0xff46495f);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setGradientFill (ColourGradient (fillColour1,
                                       160.0f - 152.0f + x,
...

    {
        ...
        Colour fillColour = Colour (0xff202029);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setColour (fillColour);
        g.fillRect (x, y, width, height);
...

    {
        ...
        Colour fillColour = Colour (0xff404049);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setColour (fillColour);
        g.fillRoundedRectangle (x, y, width, height, 14.5f);
    }
...

    {
        ...
        Colour fillColour1 = Colour (0xff002700), fillColour2 = Colour (0xba267387);
        Colour strokeColour = Colour (0xffcbcbcb);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setGradientFill (ColourGradient (fillColour1,
                                       95.0f - 6.0f + x,
        ...
        g.fillRoundedRectangle (x, y, width, height, 14.5f);
        g.setColour (strokeColour);
        g.drawRoundedRectangle (x, y, width, height, 14.5f, 1.0f);
    }
...

    {
        ...
        String text (TRANS("midiLooper"));
        Colour fillColour = Colour (0xffcbcbcb);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setColour (fillColour);
...

    {
        ...
        String text (TRANS("Insert Piz Here->"));
        Colour fillColour = Colour (0xffbfbfbf);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setColour (fillColour);
        g.setFont (Font (10.0f, Font::plain).withTypefaceStyle ("Bold"));
        g.drawText (text, x, y, width, height,
                    Justification::centred, true);
    }

    {
        ...
        Colour fillColour1 = Colour (0xff433b22), fillColour2 = Colour (0xff8b7a47);
...

    {
        ...
        Colour fillColour1 = Colour (0xff979797), fillColour2 = Colour (0xff6f737a);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setGradientFill (ColourGradient (fillColour1,
                                       100.0f - 1.0f + x,
...

    {
        ...
        Colour fillColour = Colour (0xff8c8c8c);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setColour (fillColour);
        g.fillRect (x, y, width, height);
...

    {
        ...
        Colour fillColour = Colour (0x86404049);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setColour (fillColour);
        g.fillRoundedRectangle (x, y, width, height, 10.0f);
...

    {
        ...
        Colour fillColour1 = Colours::black, fillColour2 = Colour (0xff434450);
        Colour strokeColour = Colour (0xff111111);
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setGradientFill (ColourGradient (fillColour1,
                                       256.0f - 8.0f + x,
        ...
        g.fillRoundedRectangle (x, y, width, height, 10.0f);
        g.setColour (strokeColour);
        g.drawRoundedRectangle (x, y, width, height, 10.0f, 0.7f);
    }

    {
        int x = 723, y = 64, width = 51, height = 18;
        Colour fillColour = Colour (0xffbababa);
        Colour strokeColour = Colours::black;
        //[UserPaintCustomArguments] Customize the painting arguments here..
        //[/UserPaintCustomArguments]
        g.setColour (fillColour);
...
void PizLooperEditor::buttonClicked (Button* buttonThatWasClicked)
{
    ...
    else if (buttonThatWasClicked == b_RemoveBar.get())
    {
		...
		pianoRoll->removeBar();
		LengthLabel->setText(String(pianoRoll->getDisplayLength()), NotificationType::dontSendNotification);
...
void PizLooperEditor::labelTextChanged (Label* labelThatHasChanged)
{
    ...
    else if (labelThatHasChanged == numerator.get())
    {
		...
		else numerator->setText(String(getFilter()->getNumerator(lastActiveLoop)), NotificationType::dontSendNotification);
    ...
    else if (labelThatHasChanged == denominator.get())
    {
		...
		else denominator->setText(String(getFilter()->getDenominator(lastActiveLoop)),NotificationType::dontSendNotification);
...
void PizLooperEditor::mouseUp (const MouseEvent& e)
{
	...
	else if (e.eventComponent==b_Record.get())
	{
		...
		if (e.mods.isMiddleButtonDown()) {
            ...
            slider->setValue(-1, NotificationType::sendNotification);
        }
		...
		if (e.mods.isMiddleButtonDown()) {
            //middle-click midi learn
            slider->setValue(-2, NotificationType::sendNotification);
        }
		else if (e.mods.isPopupMenu()) {
			bool hasDefaultValue= true;
			double value = slider->getDoubleClickReturnValue();
...
void PizLooperEditor::handleNoteOff(MidiKeyboardState *source, int midiChannel, int midiNoteNumber, float)
{
	if (source==&(getFilter()->keySelectorState)) {
...
void PizLooperEditor::changeListenerCallback (ChangeBroadcaster* source)
{
	...
	{
		loopinfoLabel2->setText(getFilter()->info->s,NotificationType::sendNotification);
	}
	else if (source==keySelector.get())
	{
		...
		if (getFilter()->currentNumEvents==0) {
			loopinfoLabel->setText("No Loop", NotificationType::dontSendNotification);
			...
			loopinfoLabel->setText(loopinfo, NotificationType::dontSendNotification);
...
void PizLooperEditor::updateParametersFromFilter()
{
	...
	{
		b_Snap->setToggleState(filter->getPRSetting("snap"), NotificationType::dontSendNotification);
		pianoRoll->setSnap(b_Snap->getToggleState());
		float q = filter->getPRSetting("stepsize");
		if	   (q==0.0) quantizeBox2->setText("4th", NotificationType::sendNotification);
		else if (q<0.3) quantizeBox2->setText("8th", NotificationType::sendNotification);
		else if (q<0.6) quantizeBox2->setText("16th", NotificationType::sendNotification);
		else if (q<0.9) quantizeBox2->setText("32nd", NotificationType::sendNotification);
		else quantizeBox2->setText("64th", NotificationType::sendNotification);
		b_Dotted->setToggleState(filter->getPRSetting("dotted"), NotificationType::dontSendNotification);
		b_Triplet->setToggleState(filter->getPRSetting("triplet"), NotificationType::dontSendNotification);
	...
	numerator->setText(String(n), NotificationType::dontSendNotification);
	denominator->setText(String(d), NotificationType::dontSendNotification);
	...
	getButtonForSlot(lastActiveLoop)->setToggleState(true, NotificationType::dontSendNotification);

    nameLabel->setText(filter->getProgramName(lastActiveLoop), NotificationType::dontSendNotification);
    ...
    loopinfoLabel2->setText(filter->info->s, NotificationType::dontSendNotification);
...
<JUCER_COMPONENT documentType="Component" className="PizLooperEditor" componentName=""
                 ...
                 snapPixels="8" snapActive="0" snapShown="1" overlayOpacity="0.33"
  ...
  <LABEL name="Name" id="c61a01db7e29e02e" memberName="nameLabel" virtualName="ClickableLabel"
         ...
         fontname="Default font" fontsize="26.30000000000000071054" kerning="0.0"
