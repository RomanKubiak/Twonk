...
Font PizLookAndFeel::getPopupMenuFont()
{
    return Font (13.0f);
}
...
Font PizLookAndFeel::getComboBoxFont (ComboBox& box)
{
                                             ...
                                             Slider& slider)
{
    ...
    else
    {
        ...
        if (style == Slider::LinearHorizontal || style == Slider::ThreeValueHorizontal)
        {
            ...
            g.setFont (Font((float)h,Font::bold));
        ...
        else if (style == Slider::LinearVertical || style == Slider::ThreeValueVertical)
        {
            ...
            drawTriangle (g, x + w*0.3f, sliderPos,
                          ...
                          fill, outline);
            g.setColour (slider.findColour(Slider::textBoxTextColourId).withMultipliedAlpha(0.6f));
            g.setFont (Font((float)w*0.5f,Font::bold));
...
Button* PizLookAndFeel::createSliderButton (Button &,const bool isIncrement)
{
    if (isIncrement)
